...
Voici la version mise à jour de votre fichier file:///mnt/insa/aabisaleh/Home_INSA/Cours/S3/Prog_reseaux/awaleGame/README.md avec une section ajoutée pour la documentation générée avec Doxygen :
...
La documentation générée se trouve dans le répertoire
...
Alternativement, vous pouvez naviguer manuellement vers le répertoire

html

et ouvrir le fichier `index.html` dans votre navigateur web.
